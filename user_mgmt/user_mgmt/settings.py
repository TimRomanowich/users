...
SECRET_KEY = 'django-insecure-8&(_#ihpm2k-r&yi95u7w7=2=0+(13#gk&ctqj8y=q=d((jlxq'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Added for Google/Github social login backend
...
#Allow for login using Google or Github accounts
